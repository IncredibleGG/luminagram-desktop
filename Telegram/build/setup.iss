#define MyAppShortName "LuminaGram"
#define MyAppName "LuminaGram"
#define MyAppPublisher "LuminaGram"
#define MyAppURL "https://luminagram.app"
#define MyAppExeName "LuminaGram.exe"
#define MyAppId "CD649DDC-80CB-42B5-9204-13E76C8D2972"
...
UninstallDisplayIcon={app}\LuminaGram.exe
Compression=lzma
...
[Files]
Source: "{#ReleasePath}\LuminaGram.exe"; DestDir: "{app}"; Flags: ignoreversion
